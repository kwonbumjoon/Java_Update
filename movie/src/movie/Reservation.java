...
//	}
	...
	public static Reservation cancel(String reservationID) {
		...
		try {
			bf = new BufferedReader(new FileReader(file));	// new File("reservations.txt");
			String text = "";
			String line = null;

			while ((line = bf.readLine()) != null) {
				String[] temp = line.split(",");	// 1627263849001,1627175707,에벤져스,B-4 읽어옴
...
//					private String SeatName; // 좌석
			...
			bf.close();
			// new File("reservations.txt"); => 이 경로에
	...
	// (영화제목) 영화 예매 현황
	public static ArrayList<Reservation> findMovieId(String movieId) throws NumberFormatException, IOException{
